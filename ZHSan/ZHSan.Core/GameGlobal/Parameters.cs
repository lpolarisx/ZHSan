...
namespace GameGlobal
{
    ...
    public class Parameters
    {
        ...
        {
            AIArchitectureDamageRate = config.AIArchitectureDamageRate;
            AIFoodRate = config.AIFoodRate;
            AIFundRate = config.AIFundRate;
            AIRecruitmentSpeedRate = config.AIRecruitmentSpeedRate;
            AITrainingSpeedRate = config.AITrainingSpeedRate;
            AITroopDefenceRate = config.AITroopDefenceRate;
            AITroopOffenceRate = config.AITroopOffenceRate;
            ArchitectureDamageRate = config.ArchitectureDamageRate;
            AIAntiStratagem = config.AIAntiStratagem;
            AIAntiSurround = config.AIAntiSurround;
            BuyFoodAgriculture = config.BuyFoodAgriculture;
            ChangeCapitalCost = config.ChangeCapitalCost;
            ConvincePersonCost = config.ConvincePersonCost;
            DefaultPopulationDevelopingRate = config.DefaultPopulationDevelopingRate;
            DestroyArchitectureCost = config.DestroyArchitectureCost;
            FindTreasureChance = config.FindTreasureChance;
            FireDamageScale = config.FireDamageScale;
            FollowedLeaderDefenceRateIncrement = config.FollowedLeaderDefenceRateIncrement;
            FollowedLeaderOffenceRateIncrement = config.FollowedLeaderOffenceRateIncrement;
            FoodRate = config.FoodRate;
            FoodToFundDivisor = config.FoodToFundDivisor;
            FundRate = config.FundRate;
            FundToFoodMultiple = config.FundToFoodMultiple;
            GossipArchitectureCost = config.GossipArchitectureCost;
            JailBreakArchitectureCost = config.JailBreakArchitectureCost;
            InstigateArchitectureCost = config.InstigateArchitectureCost;
            InternalFundCost = config.InternalFundCost;
            InternalRate = config.InternalRate;
            LearnSkillDays = config.LearnSkillDays;
            LearnStuntDays = config.LearnStuntDays;
            LearnTitleDays = config.LearnTitleDays;
            SearchDays = config.SearchDays;
            RecruitmentDomination = config.RecruitmentDomination;
            RecruitmentFundCost = config.RecruitmentFundCost;
            RecruitmentMorale = config.RecruitmentMorale;
            RecruitmentRate = config.RecruitmentRate;
            RewardPersonCost = config.RewardPersonCost;
            SellFoodCommerce = config.SellFoodCommerce;
            SurroundArchitectureDominationUnit = config.SurroundArchitectureDominationUnit;
            TrainingRate = config.TrainingRate;
            TroopDamageRate = config.TroopDamageRate;
            AIArchitectureDamageYearIncreaseRate = config.AIArchitectureDamageYearIncreaseRate;
            AIFoodYearIncreaseRate = config.AIFoodYearIncreaseRate;
            AIFundYearIncreaseRate = config.AIFundYearIncreaseRate;
            AIRecruitmentSpeedYearIncreaseRate = config.AIRecruitmentSpeedYearIncreaseRate;
            AITrainingSpeedYearIncreaseRate = config.AITrainingSpeedYearIncreaseRate;
            AITroopDefenceYearIncreaseRate = config.AITroopDefenceYearIncreaseRate;
            AITroopOffenceYearIncreaseRate = config.AITroopOffenceYearIncreaseRate;
            AIArmyExperienceYearIncreaseRate = config.AIArmyExperienceYearIncreaseRate;
            AIOfficerExperienceYearIncreaseRate = config.AIOfficerExperienceYearIncreaseRate;
            AIAntiStratagemIncreaseRate = config.AIAntiStratagemIncreaseRate;
            AIAntiSurroundIncreaseRate = config.AIAntiSurroundIncreaseRate;
            AIOfficerExperienceRate = config.AIOfficerExperienceRate;
            AIArmyExperienceRate = config.AIArmyExperienceRate;
            BasicAIArchitectureDamageRate = config.BasicAIArchitectureDamageRate;
            BasicAIFoodRate = config.BasicAIFoodRate;
            BasicAIFundRate = config.BasicAIFundRate;
            BasicAIRecruitmentSpeedRate = config.BasicAIRecruitmentSpeedRate;
            BasicAITrainingSpeedRate = config.BasicAITrainingSpeedRate;
            BasicAITroopDefenceRate = config.BasicAITroopDefenceRate;
            BasicAITroopOffenceRate = config.BasicAITroopOffenceRate;
            BasicAIArmyExperienceRate = config.BasicAIArmyExperienceRate;
            BasicAIOfficerExperienceRate = config.BasicAIOfficerExperienceRate;
            BasicAIAntiStratagem = config.BasicAIAntiStratagem;
            BasicAIAntiSurround = config.BasicAIAntiSurround;
            AIBackendArmyReserveCalmBraveDifferenceMultiply = config.AIBackendArmyReserveCalmBraveDifferenceMultiply;
            AIBackendArmyReserveAmbitionMultiply = config.AIBackendArmyReserveAmbitionMultiply;
            AIBackendArmyReserveAdd = config.AIBackendArmyReserveAdd;
            AIBackendArmyReserveMultiply = config.AIBackendArmyReserveMultiply;
            AITradePeriod = config.AITradePeriod;
            AITreasureChance = config.AITreasureChance;
            AITreasureCountMax = config.AITreasureCountMax;
            AITreasureCountCappedTitleLevelAdd = config.AITreasureCountCappedTitleLevelAdd;
            AITreasureCountCappedTitleLevelMultiply = config.AITreasureCountCappedTitleLevelMultiply;
            AIGiveTreasureMaxWorth = config.AIGiveTreasureMaxWorth;
            AIFacilityFundMonthWaitParam = config.AIFacilityFundMonthWaitParam;
            AIFacilityDestroyValueRate = config.AIFacilityDestroyValueRate;
            AIBuildHougongUnambitionProbWeight = config.AIBuildHougongUnambitionProbWeight;
            AIBuildHougongSpaceBuiltProbWeight = config.AIBuildHougongSpaceBuiltProbWeight;
            AIBuildHougongMaxSizeAdd = config.AIBuildHougongMaxSizeAdd;
            AIBuildHougongSkipSizeChance = config.AIBuildHougongSkipSizeChance;
            AINafeiUncreultyProbAdd = config.AINafeiUncreultyProbAdd;
            AINafeiAbilityThresholdRate = config.AINafeiAbilityThresholdRate;
            AINafeiStealSpouseThresholdRateAdd = config.AINafeiStealSpouseThresholdRateAdd;
            AINafeiStealSpouseThresholdRateMultiply = config.AINafeiStealSpouseThresholdRateMultiply;
            AINafeiMaxAgeThresholdAdd = config.AINafeiMaxAgeThresholdAdd;
            AINafeiMaxAgeThresholdMultiply = config.AINafeiMaxAgeThresholdMultiply;
            AINafeiSkipChanceAdd = config.AINafeiSkipChanceAdd;
            AINafeiSkipChanceMultiply = config.AINafeiSkipChanceMultiply;
            AIRecruitPopulationCapMultiply = config.AIRecruitPopulationCapMultiply;
            AIRecruitPopulationCapBackendMultiply = config.AIRecruitPopulationCapBackendMultiply;
            AIRecruitPopulationCapHostilelineMultiply = config.AIRecruitPopulationCapHostilelineMultiply;
            AIRecruitPopulationCapStrategyTendencyMulitply = config.AIRecruitPopulationCapStrategyTendencyMulitply;
            AIRecruitPopulationCapStrategyTendencyAdd = config.AIRecruitPopulationCapStrategyTendencyAdd;
            AINewMilitaryPopulationThresholdDivide = config.AINewMilitaryPopulationThresholdDivide;
            AINewMilitaryPersonThresholdDivide = config.AINewMilitaryPersonThresholdDivide;
            AIExecuteMaxUncreulty = config.AIExecuteMaxUncreulty;
            AIExecutePersonIdealToleranceMultiply = config.AIExecutePersonIdealToleranceMultiply;
            FireStayProb = config.FireStayProb;
            FireSpreadProbMultiply = config.FireSpreadProbMultiply;
            MinPregnantProb = config.MinPregnantProb;
            InternalExperienceRate = config.InternalExperienceRate;
            AbilityExperienceRate = config.AbilityExperienceRate;
            ArmyExperienceRate = config.ArmyExperienceRate;
            AIAttackChanceIfUnfull = config.AIAttackChanceIfUnfull;
            AIObeyStrategyTendencyChance = config.AIObeyStrategyTendencyChance;
            AIOffendMaxDiplomaticRelationMultiply = config.AIOffendMaxDiplomaticRelationMultiply;
            AIOffendDefendTroopAdd = config.AIOffendDefendTroopAdd;
            AIOffendDefendTroopMultiply = config.AIOffendDefendTroopMultiply;
            AIOffendIgnoreReserveProbAmbitionMultiply = config.AIOffendIgnoreReserveProbAmbitionMultiply;
            AIOffendIgnoreReserveProbAmbitionAdd = config.AIOffendIgnoreReserveProbAmbitionAdd;
            AIOffendIgnoreReserveProbBCDiffMultiply = config.AIOffendIgnoreReserveProbBCDiffMultiply;
            AIOffendIgnoreReserveProbBCDiffAdd = config.AIOffendIgnoreReserveProbBCDiffAdd;
            AIOffendIgnoreReserveChanceTroopRatioAdd = config.AIOffendIgnoreReserveChanceTroopRatioAdd;
            AIOffendIgnoreReserveChanceTroopRatioMultiply = config.AIOffendIgnoreReserveChanceTroopRatioMultiply;
            PrincessMaintainenceCost = config.PrincessMaintainenceCost;
            AIUniqueTroopFightingForceThreshold = config.AIUniqueTroopFightingForceThreshold;
            LearnSkillSuccessRate = config.LearnSkillSuccessRate;
            LearnStuntSuccessRate = config.LearnStuntSuccessRate;
            LearnTitleSuccessRate = config.LearnTitleSuccessRate;
            AutoLearnSkillSuccessRate = config.AutoLearnSkillSuccessRate;
            AutoLearnStuntSuccessRate = config.AutoLearnStuntSuccessRate;
            MilitaryPopulationCap = config.MilitaryPopulationCap;
            MilitaryPopulationReloadQuantity = config.MilitaryPopulationReloadQuantity;
            CloseThreshold = config.CloseThreshold;
            HateThreshold = config.HateThreshold;
            VeryCloseThreshold = config.VeryCloseThreshold;
            MaxAITroopCountCandidates = config.MaxAITroopCountCandidates;
            PopulationDevelopingRate = config.PopulationDevelopingRate;
            CloseAbilityRate = config.CloseAbilityRate;
            VeryCloseAbilityRate = config.VeryCloseAbilityRate;
            AIEncirclePlayerRate = config.AIEncirclePlayerRate;
            BasicAIExtraPerson = config.BasicAIExtraPerson;
            AIExtraPerson = config.AIExtraPerson;
            AIExtraPersonIncreaseRate = config.AIExtraPersonIncreaseRate;
            AITirednessDecrease = config.AITirednessDecrease;
            InternalSurplusFactor = config.InternalSurplusFactor;
            MakeMarrigeIdealLimit = config.MakeMarrigeIdealLimit;
            MakeMarriageCost = config.MakeMarriageCost;
            NafeiCost = config.NafeiCost;
            SelectPrinceCost = config.SelectPrinceCost;
            TransferCostPerMilitary = config.TransferCostPerMilitary;
            TransferFoodPerMilitary = config.TransferFoodPerMilitary;
            AIEncircleRank = config.AIEncircleRank;
            AIEncircleVar = config.AIEncircleVar;
            RansomRate = config.RansomRate;
            ExpandConditions = config.ExpandConditions;
            SearchPersonArchitectureCountPower = config.SearchPersonArchitectureCountPower;
            DayInTurn = config.DayInTurn;
            MaxRelation = config.MaxRelation;
            HougongRelationHateFactor = config.HougongRelationHateFactor;
            AIMaxFeizi = config.AIMaxFeizi;
            MaxReputationForRecruit = config.MaxReputationForRecruit;
            TroopMoraleChange = config.TroopMoraleChange;
            RecruitPopualationDecreaseRate = config.RecruitPopualationDecreaseRate;
            AIOffensiveCampaignRequiredScaleFactor = config.AIOffensiveCampaignRequiredScaleFactor;
            PersonCap = config.PersonCap;
            PersonCapFalldown = config.PersonCapFalldown;
            AlienTroopGain = config.AlienTroopGain;
            TrainAbilityCost = config.TrainAbilityCost;
            TrainAbilityTiredness = config.TrainAbilityTiredness;
            TrainAbilityAmount = config.TrainAbilityAmount;
            OfficerBaseSalary = config.OfficerBaseSalary;
            SalaryLoyaltyLoss = config.SalaryLoyaltyLoss;
        }

        public ParametersConfig ToConfig()
        {
            return new ParametersConfig
            {
                AIArchitectureDamageRate = AIArchitectureDamageRate,
                AIFoodRate = AIFoodRate,
                AIFundRate = AIFundRate,
                AIRecruitmentSpeedRate = AIRecruitmentSpeedRate,
                AITrainingSpeedRate = AITrainingSpeedRate,
                AITroopDefenceRate = AITroopDefenceRate,
                AITroopOffenceRate = AITroopOffenceRate,
                ArchitectureDamageRate = ArchitectureDamageRate,
                AIAntiStratagem = AIAntiStratagem,
                AIAntiSurround = AIAntiSurround,
                BuyFoodAgriculture = BuyFoodAgriculture,
                ChangeCapitalCost = ChangeCapitalCost,
                ConvincePersonCost = ConvincePersonCost,
                DefaultPopulationDevelopingRate = DefaultPopulationDevelopingRate,
                DestroyArchitectureCost = DestroyArchitectureCost,
                FindTreasureChance = FindTreasureChance,
                FireDamageScale = FireDamageScale,
                FollowedLeaderDefenceRateIncrement = FollowedLeaderDefenceRateIncrement,
                FollowedLeaderOffenceRateIncrement = FollowedLeaderOffenceRateIncrement,
                FoodRate = FoodRate,
                FoodToFundDivisor = FoodToFundDivisor,
                FundRate = FundRate,
                FundToFoodMultiple = FundToFoodMultiple,
                GossipArchitectureCost = GossipArchitectureCost,
                JailBreakArchitectureCost = JailBreakArchitectureCost,
                InstigateArchitectureCost = InstigateArchitectureCost,
                InternalFundCost = InternalFundCost,
                InternalRate = InternalRate,
                LearnSkillDays = LearnSkillDays,
                LearnStuntDays = LearnStuntDays,
                LearnTitleDays = LearnTitleDays,
                SearchDays = SearchDays,
                RecruitmentDomination = RecruitmentDomination,
                RecruitmentFundCost = RecruitmentFundCost,
                RecruitmentMorale = RecruitmentMorale,
                RecruitmentRate = RecruitmentRate,
                RewardPersonCost = RewardPersonCost,
                SellFoodCommerce = SellFoodCommerce,
                SurroundArchitectureDominationUnit = SurroundArchitectureDominationUnit,
                TrainingRate = TrainingRate,
                TroopDamageRate = TroopDamageRate,
                AIArchitectureDamageYearIncreaseRate = AIArchitectureDamageYearIncreaseRate,
                AIFoodYearIncreaseRate = AIFoodYearIncreaseRate,
                AIFundYearIncreaseRate = AIFundYearIncreaseRate,
                AIRecruitmentSpeedYearIncreaseRate = AIRecruitmentSpeedYearIncreaseRate,
                AITrainingSpeedYearIncreaseRate = AITrainingSpeedYearIncreaseRate,
                AITroopDefenceYearIncreaseRate = AITroopDefenceYearIncreaseRate,
                AITroopOffenceYearIncreaseRate = AITroopOffenceYearIncreaseRate,
                AIArmyExperienceYearIncreaseRate = AIArmyExperienceYearIncreaseRate,
                AIOfficerExperienceYearIncreaseRate = AIOfficerExperienceYearIncreaseRate,
                AIAntiStratagemIncreaseRate = AIAntiStratagemIncreaseRate,
                AIAntiSurroundIncreaseRate = AIAntiSurroundIncreaseRate,
                AIOfficerExperienceRate = AIOfficerExperienceRate,
                AIArmyExperienceRate = AIArmyExperienceRate,
                BasicAIArchitectureDamageRate = BasicAIArchitectureDamageRate,
                BasicAIFoodRate = BasicAIFoodRate,
                BasicAIFundRate = BasicAIFundRate,
                BasicAIRecruitmentSpeedRate = BasicAIRecruitmentSpeedRate,
                BasicAITrainingSpeedRate = BasicAITrainingSpeedRate,
                BasicAITroopDefenceRate = BasicAITroopDefenceRate,
                BasicAITroopOffenceRate = BasicAITroopOffenceRate,
                BasicAIArmyExperienceRate = BasicAIArmyExperienceRate,
                BasicAIOfficerExperienceRate = BasicAIOfficerExperienceRate,
                BasicAIAntiStratagem = BasicAIAntiStratagem,
                BasicAIAntiSurround = BasicAIAntiSurround,
                AIBackendArmyReserveCalmBraveDifferenceMultiply = AIBackendArmyReserveCalmBraveDifferenceMultiply,
                AIBackendArmyReserveAmbitionMultiply = AIBackendArmyReserveAmbitionMultiply,
                AIBackendArmyReserveAdd = AIBackendArmyReserveAdd,
                AIBackendArmyReserveMultiply = AIBackendArmyReserveMultiply,
                AITradePeriod = AITradePeriod,
                AITreasureChance = AITreasureChance,
                AITreasureCountMax = AITreasureCountMax,
                AITreasureCountCappedTitleLevelAdd = AITreasureCountCappedTitleLevelAdd,
                AITreasureCountCappedTitleLevelMultiply = AITreasureCountCappedTitleLevelMultiply,
                AIGiveTreasureMaxWorth = AIGiveTreasureMaxWorth,
                AIFacilityFundMonthWaitParam = AIFacilityFundMonthWaitParam,
                AIFacilityDestroyValueRate = AIFacilityDestroyValueRate,
                AIBuildHougongUnambitionProbWeight = AIBuildHougongUnambitionProbWeight,
                AIBuildHougongSpaceBuiltProbWeight = AIBuildHougongSpaceBuiltProbWeight,
                AIBuildHougongMaxSizeAdd = AIBuildHougongMaxSizeAdd,
                AIBuildHougongSkipSizeChance = AIBuildHougongSkipSizeChance,
                AINafeiUncreultyProbAdd = AINafeiUncreultyProbAdd,
                AINafeiAbilityThresholdRate = AINafeiAbilityThresholdRate,
                AINafeiStealSpouseThresholdRateAdd = AINafeiStealSpouseThresholdRateAdd,
                AINafeiStealSpouseThresholdRateMultiply = AINafeiStealSpouseThresholdRateMultiply,
                AINafeiMaxAgeThresholdAdd = AINafeiMaxAgeThresholdAdd,
                AINafeiMaxAgeThresholdMultiply = AINafeiMaxAgeThresholdMultiply,
                AINafeiSkipChanceAdd = AINafeiSkipChanceAdd,
                AINafeiSkipChanceMultiply = AINafeiSkipChanceMultiply,
                AIRecruitPopulationCapMultiply = AIRecruitPopulationCapMultiply,
                AIRecruitPopulationCapBackendMultiply = AIRecruitPopulationCapBackendMultiply,
                AIRecruitPopulationCapHostilelineMultiply = AIRecruitPopulationCapHostilelineMultiply,
                AIRecruitPopulationCapStrategyTendencyMulitply = AIRecruitPopulationCapStrategyTendencyMulitply,
                AIRecruitPopulationCapStrategyTendencyAdd = AIRecruitPopulationCapStrategyTendencyAdd,
                AINewMilitaryPopulationThresholdDivide = AINewMilitaryPopulationThresholdDivide,
                AINewMilitaryPersonThresholdDivide = AINewMilitaryPersonThresholdDivide,
                AIExecuteMaxUncreulty = AIExecuteMaxUncreulty,
                AIExecutePersonIdealToleranceMultiply = AIExecutePersonIdealToleranceMultiply,
                FireStayProb = FireStayProb,
                FireSpreadProbMultiply = FireSpreadProbMultiply,
                MinPregnantProb = MinPregnantProb,
                InternalExperienceRate = InternalExperienceRate,
                AbilityExperienceRate = AbilityExperienceRate,
                ArmyExperienceRate = ArmyExperienceRate,
                AIAttackChanceIfUnfull = AIAttackChanceIfUnfull,
                AIObeyStrategyTendencyChance = AIObeyStrategyTendencyChance,
                AIOffendMaxDiplomaticRelationMultiply = AIOffendMaxDiplomaticRelationMultiply,
                AIOffendDefendTroopAdd = AIOffendDefendTroopAdd,
                AIOffendDefendTroopMultiply = AIOffendDefendTroopMultiply,
                AIOffendIgnoreReserveProbAmbitionMultiply = AIOffendIgnoreReserveProbAmbitionMultiply,
                AIOffendIgnoreReserveProbAmbitionAdd = AIOffendIgnoreReserveProbAmbitionAdd,
                AIOffendIgnoreReserveProbBCDiffMultiply = AIOffendIgnoreReserveProbBCDiffMultiply,
                AIOffendIgnoreReserveProbBCDiffAdd = AIOffendIgnoreReserveProbBCDiffAdd,
                AIOffendIgnoreReserveChanceTroopRatioAdd = AIOffendIgnoreReserveChanceTroopRatioAdd,
                AIOffendIgnoreReserveChanceTroopRatioMultiply = AIOffendIgnoreReserveChanceTroopRatioMultiply,
                PrincessMaintainenceCost = PrincessMaintainenceCost,
                AIUniqueTroopFightingForceThreshold = AIUniqueTroopFightingForceThreshold,
                LearnSkillSuccessRate = LearnSkillSuccessRate,
                LearnStuntSuccessRate = LearnStuntSuccessRate,
                LearnTitleSuccessRate = LearnTitleSuccessRate,
                AutoLearnSkillSuccessRate = AutoLearnSkillSuccessRate,
                AutoLearnStuntSuccessRate = AutoLearnStuntSuccessRate,
                MilitaryPopulationCap = MilitaryPopulationCap,
                MilitaryPopulationReloadQuantity = MilitaryPopulationReloadQuantity,
                CloseThreshold = CloseThreshold,
                HateThreshold = HateThreshold,
                VeryCloseThreshold = VeryCloseThreshold,
                MaxAITroopCountCandidates = MaxAITroopCountCandidates,
                PopulationDevelopingRate = PopulationDevelopingRate,
                CloseAbilityRate = CloseAbilityRate,
                VeryCloseAbilityRate = VeryCloseAbilityRate,
                AIEncirclePlayerRate = AIEncirclePlayerRate,
                BasicAIExtraPerson = BasicAIExtraPerson,
                AIExtraPerson = AIExtraPerson,
                AIExtraPersonIncreaseRate = AIExtraPersonIncreaseRate,
                AITirednessDecrease = AITirednessDecrease,
                InternalSurplusFactor = InternalSurplusFactor,
                MakeMarrigeIdealLimit = MakeMarrigeIdealLimit,
                MakeMarriageCost = MakeMarriageCost,
                NafeiCost = NafeiCost,
                SelectPrinceCost = SelectPrinceCost,
                TransferCostPerMilitary = TransferCostPerMilitary,
                TransferFoodPerMilitary = TransferFoodPerMilitary,
                AIEncircleRank = AIEncircleRank,
                AIEncircleVar = AIEncircleVar,
                RansomRate = RansomRate,
                ExpandConditions = ExpandConditions,
                SearchPersonArchitectureCountPower = SearchPersonArchitectureCountPower,
                DayInTurn = DayInTurn,
                MaxRelation = MaxRelation,
                HougongRelationHateFactor = HougongRelationHateFactor,
                AIMaxFeizi = AIMaxFeizi,
                MaxReputationForRecruit = MaxReputationForRecruit,
                TroopMoraleChange = TroopMoraleChange,
                RecruitPopualationDecreaseRate = RecruitPopualationDecreaseRate,
                AIOffensiveCampaignRequiredScaleFactor = AIOffensiveCampaignRequiredScaleFactor,
                PersonCap = PersonCap,
                PersonCapFalldown = PersonCapFalldown,
                AlienTroopGain = AlienTroopGain,
                TrainAbilityCost = TrainAbilityCost,
                TrainAbilityTiredness = TrainAbilityTiredness,
                TrainAbilityAmount = TrainAbilityAmount,
                OfficerBaseSalary = OfficerBaseSalary,
                SalaryLoyaltyLoss = SalaryLoyaltyLoss,
            };
        }
