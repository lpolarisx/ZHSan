...
namespace GameObjects
{
    public class Military : GameObject
    {
        ...
        {
            // 行动力
            int movability = Kind.Movability;
            ...
            for (int i = area.Count - 1; i >= 0; i--)
            {
                ...
                else if (Session.Current.Scenario.GetWaterPositionMapCost(Kind, point) >= 3500)
                {
                    area.Area.RemoveAt(i);
                }
            }
        ...
        public string TrainingString
        {
            get
            {
                ...
                else if (this.BelongedArchitecture != null && BelongedArchitecture.GetTrainingPersons().Count > 0)
                {
                    return "↑";
                }
                else
        ...
        public string YijingXunlianHao
        {
            get
            {
                ...
                else if (BelongedArchitecture != null && BelongedArchitecture.GetTrainingPersons().Count > 0)
                {
                    return "↑";
                }
                else
