...
public class CombatMethod : GameObject
{
    ...
    public CombatMethod(CombatMethodConfig config)
    {
        ID = config.Id;
        Name = config.Name;
        ...
        ViewingHostile = config.ViewingHostile;
        AnimationKind = config.AnimationKind;
        AttackDefaultString = config.AttackDefaultString;
        AttackTargetString = config.AttackTargetString;
        AIConditionWeightSelfString = config.AIConditionWeightEnemyString;
