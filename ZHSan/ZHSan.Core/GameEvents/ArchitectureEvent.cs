...
public record ReleaseCaptiveEvent(Architecture architecture, List<Person> persons);
...
public record ArchitectureEvent(Event archEvent, Architecture architecture, Screen screen);